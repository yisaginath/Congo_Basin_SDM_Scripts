...
modelPerformanceAllSpecies <- read.csv("F:/WWF_data/SDMs_LC_climate/ape_elephant_summary.csv") %>%
...
elephant_observations <- read.csv("F:/WWF_data/SDMs_LC_climate/elephants.csv")
...
for (i in 1:nrow(modelPerformanceAllSpecies)) {
  ...
  for (k in 1:5) {
    ...
    variable_importance_dir <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/current/variable_importance_temp")
    ...
    output_dir <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/current"
    ...
    output_dir1 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/current/average"
    ...
    # Define file paths
    species_dir <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/current/binary", gsub(" ", "_", scientific_name_i))
...
for (i in 1:nrow(modelPerformanceAllSpecies)) {
  ...
  for (k in 1:5) {
    ...
    # Get variable importance from the fitted Maxent model
    # Define output directory for variable importance (if not already defined)
    variable_importance_dir <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/ssp126/variable_importance_temp")
    dir.create(variable_importance_dir, recursive = TRUE, showWarnings = FALSE)
    ...
    # Define the directory where the prediction files will be saved
    output_dir <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/ssp126"
    ...
    # Define output path for the average suitability raster
    output_dir1 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/sspp126/average"
    dir.create(output_dir1, recursive = TRUE, showWarnings = FALSE)
    avg_suitability_path <- file.path(output_dir1, paste0("weighted_avg_habitat_suitability_", scientific_name_i, ".tif"))
    ...
    # Define file paths
    species_dir <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/sspp126/binary", gsub(" ", "_", scientific_name_i))
    dir.create(file.path(species_dir, "binary_mammals"), showWarnings = FALSE, recursive = TRUE)
...
for (i in 1:nrow(modelPerformanceAllSpecies)) {
  ...
  for (k in 1:5) {
    ...
    # Get variable importance from the fitted Maxent model
    # Define output directory for variable importance (if not already defined)
    variable_importance_dir <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/variable_importance_temp")
    dir.create(variable_importance_dir, recursive = TRUE, showWarnings = FALSE)
    ...
    # Define the directory where the prediction files will be saved
    output_dir <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030"
    ...
    # Define output path for the average suitability raster
    output_dir1 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/average"
    dir.create(output_dir1, recursive = TRUE, showWarnings = FALSE)
    avg_suitability_path <- file.path(output_dir1, paste0("weighted_avg_habitat_suitability_", scientific_name_i, ".tif"))
    ...
    # Define file paths
    species_dir <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/binary", gsub(" ", "_", scientific_name_i))
    dir.create(file.path(species_dir, "binary_mammals"), showWarnings = FALSE, recursive = TRUE)
    ...
    # Define the directory where the prediction files will be saved
    output_dir22 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2030/ssp245"
    ...
    # Define output path for the average suitability raster
    output_dir33 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/2030/ssp245/average"
    ...
    if (!is.na(species_i_threshold)) {
      ...
      species_dir11 <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2030/ssp245", gsub(" ", "_", scientific_name_i))
    ...
    # Define the directory where the prediction files will be saved
    output_dir222 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2030/ssp585"
    ...
    # Define output path for the average suitability raster
    output_dir333 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2030/ssp585/average"
    ...
    if (!is.na(species_i_threshold)) {
      ...
      species_dir111 <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2030/ssp585", gsub(" ", "_", scientific_name_i))
    ...
    # Define the directory where the prediction files will be saved
    output_dir2 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2050/ssp126"
    ...
    # Define output path for the average suitability raster
    output_dir3 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2050/ssp126/average"
    ...
    if (!is.na(species_i_threshold)) {
      ...
      species_dir1 <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2050/ssp126", gsub(" ", "_", scientific_name_i))
    ...
    # Define the directory where the prediction files will be saved
    output_dir22 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2050/ssp245"
    ...
    # Define output path for the average suitability raster
    output_dir33 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/2050/ssp245/average"
    dir.create(output_dir33, recursive = TRUE, showWarnings = FALSE)
    ...
    if (!is.na(species_i_threshold)) {
      ...
      species_dir11 <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2050/ssp245", gsub(" ", "_", scientific_name_i))
      dir.create(file.path(species_dir11, "binary"), showWarnings = FALSE, recursive = TRUE)
    ...
    # Define the directory where the prediction files will be saved
    output_dir222 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2050/ssp585"
    ...
    # Define output path for the average suitability raster
    output_dir333 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2050/ssp585/average"
    dir.create(output_dir333, recursive = TRUE, showWarnings = FALSE)
    ...
    if (!is.na(species_i_threshold)) {
      ...
      species_dir111 <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2050/ssp585", gsub(" ", "_", scientific_name_i))
      dir.create(file.path(species_dir111, "binary"), showWarnings = FALSE, recursive = TRUE)
    ...
    # Define the directory where the prediction files will be saved
    output_dir2 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2070/ssp126"
    ...
    # Define output path for the average suitability raster
    output_dir3 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2070/ssp126/average"
    dir.create(output_dir3, recursive = TRUE, showWarnings = FALSE)
    ...
    if (!is.na(species_i_threshold)) {
      ...
      species_dir1 <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2070/ssp126", gsub(" ", "_", scientific_name_i))
      dir.create(file.path(species_dir1, "binary"), showWarnings = FALSE, recursive = TRUE)
    ...
    # Define the directory where the prediction files will be saved
    output_dir22 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2070/ssp245"
    ...
    # Define output path for the average suitability raster
    output_dir33 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/2070/ssp245/average"
    dir.create(output_dir33, recursive = TRUE, showWarnings = FALSE)
    ...
    if (!is.na(species_i_threshold)) {
      ...
      species_dir11 <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2070/ssp245", gsub(" ", "_", scientific_name_i))
      dir.create(file.path(species_dir11, "binary"), showWarnings = FALSE, recursive = TRUE)
    ...
    # Define the directory where the prediction files will be saved
    output_dir222 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2070/ssp585"
    ...
    # Define output path for the average suitability raster
    output_dir333 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2070/ssp585/average"
    dir.create(output_dir333, recursive = TRUE, showWarnings = FALSE)
    ...
    if (!is.na(species_i_threshold)) {
      ...
      species_dir111 <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2070/ssp585", gsub(" ", "_", scientific_name_i))
      dir.create(file.path(species_dir111, "binary"), showWarnings = FALSE, recursive = TRUE)
    ...
    # Define the directory where the prediction files will be saved
    output_dir23 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2100/ssp126"
    ...
    # Define output path for the average suitability raster
    output_dir32 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2100/ssp126/average"
    ...
    if (!is.na(species_i_threshold)) {
      ...
      species_dir12 <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2100/ssp126", gsub(" ", "_", scientific_name_i))
    ...
    # Define the directory where the prediction files will be saved
    output_dir223 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2100/ssp245"
    ...
    # Define output path for the average suitability raster
    output_dir331 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2100/ssp245/average"
    ...
    if (!is.na(species_i_threshold)) {
      ...
      species_dir113 <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2100/ssp245", gsub(" ", "_", scientific_name_i))
    ...
    # Define the directory where the prediction files will be saved
    output_dir2223 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2100/ssp585"
    ...
    # Define output path for the average suitability raster
    output_dir3331 <- "F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2100/ssp585/average"
    ...
    if (!is.na(species_i_threshold)) {
      ...
      species_dir1112 <- file.path("F:/WWF_data/SDMs_LC_climate/results/ape_elephant/from_2030/future/2100/ssp585", gsub(" ", "_", scientific_name_i))
